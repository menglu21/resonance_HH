...
class btagSFProducer(Module):
    ...
    def __init__(
        ...
        self.systs.append("down_isr")
        self.systs.append("down_fsr")
        self.systs.append("down_hdamp")
        self.systs.append("down_jes")
        self.systs.append("down_jer")
        self.systs.append("down_pileup")
        self.systs.append("down_qcdscale")
        self.systs.append("down_statistic")
        self.systs.append("down_topmass")
        self.systs.append("down_type3")
        self.systs.append("up_isr")
        self.systs.append("up_fsr")
        self.systs.append("up_hdamp")
        self.systs.append("up_jes")
        self.systs.append("up_jer")
        self.systs.append("up_pileup")
        self.systs.append("up_qcdscale")
        self.systs.append("up_statistic")
        self.systs.append("up_topmass")
        self.systs.append("up_type3")
